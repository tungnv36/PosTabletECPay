...
public class SQLiteConnection extends SQLiteOpenHelper {
    ...
    private SQLiteConnection(Context context) {
        super(context, Environment.getExternalStorageDirectory() + "/PosTablet/DB/" + databaseName, null, version);
        SQLiteDatabase.openOrCreateDatabase(Environment.getExternalStorageDirectory() + "/PosTablet/DB/" + databaseName, null);
    }
